			...
			for random_state in random_state_list:
				for k in k_list:
					for min_data_in_leaf in min_data_in_leaf_list:
						print("converting lightgbm_{}_{}_{}_{}_{}.txt".format(n_tree, depth, random_state, k, min_data_in_leaf))
						p = subprocess.run(["python3", "convert_forest_to_json_by_cmd.py", dataset, n_tree, depth, random_state, k, "--min_data_in_leaf", min_data_in_leaf], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
						print(p.stdout)
						print(p.stderr)